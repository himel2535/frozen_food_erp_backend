...
export const LIST_FIELD_PROFILES: Record<string, string> = {
  ...
  Product: 'legacyId tenantId name sku category status price cost stock reorderLevel unit imageUrl createdAt updatedAt',
  ...
  Project: 'legacyId tenantId name status progress deadline lead createdAt updatedAt',
  Department: 'legacyId tenantId name status createdAt updatedAt',
  Designation: 'legacyId tenantId name department status createdAt updatedAt',
