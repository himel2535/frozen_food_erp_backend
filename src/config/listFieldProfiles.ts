...
export const LIST_FIELD_PROFILES: Record<string, string> = {
  ...
  'Purchase order': 'legacyId tenantId supplier supplierName status total due balance date expectedDelivery deliveryDate items attachmentUrl attachmentName createdAt updatedAt',
  ...
  Asset: 'legacyId tenantId name asset category status value purchaseDate createdAt updatedAt',
