...
const EXTENDED_RESOURCES: ResourceDef[] = [
  ...
  { path: '/projects', model: Project, resourceName: 'Project', searchFields: ['legacyId', 'name'], legacyIdPrefix: 'PROJ' },
  { path: '/assets', model: Asset, resourceName: 'Asset', searchFields: ['legacyId', 'name', 'code'], legacyIdPrefix: 'AST' },
